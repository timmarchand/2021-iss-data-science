...
#install.packages(tidylog) # once per computer
library(tidylog) # to keep track of the changes


## Alternative, use pacman::p_load
#install.packages(pacman) # once per computer
# pacman::p_load(dplyr,nycflights13,ggplot2,tidylog)
